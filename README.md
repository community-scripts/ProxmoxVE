...
- **Twitter**: Follow us on Twitter [@ProxmoxHelpers](https://twitter.com/ProxmoxHelpers).
...
Please refer to the `requirements` section in the [script documentation](https://github.com/community-scripts/ProxmoxVE/blob/main/README.md) for a detailed list of dependencies.

...
export const InstallMethodSchema = z.object({
  type: z.enum(["default", "alpine"], {
    error: "Type must be either 'default' or 'alpine'",
  }),
...
export const ScriptSchema = z
  .object({
    ...
    type: z.enum(["vm", "ct", "pve", "addon", "turnkey"], {
      error: "Type must be either 'vm', 'ct', 'pve', 'addon' or 'turnkey'",
    }),
    ...
    install_methods: z
      .array(InstallMethodSchema)
      .min(1, "At least one install method is required"),

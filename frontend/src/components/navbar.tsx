...
function Navbar() {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-50 flex w-screen justify-center px-4 xl:px-0 ${
    ...
    >
      <div className="flex h-20 w-full max-w-[1440px] items-center justify-between sm:flex-row">
        <Link
          href="/"
          className="hidden w-full cursor-pointer flex-row-reverse items-center justify-center gap-2 font-semibold sm:flex sm:flex-row sm:justify-start"
        >
          <Image
            height={18}
            unoptimized

...
export default function StarOnGithubButton() {
  ...
  return (
    ...
    >
      <span className="-mt-12 group-hover:-translate-x-40 absolute right-0 h-32 translate-x-12 rotate-12 bg-white opacity-10 transition-all duration-1000 ease-out" />

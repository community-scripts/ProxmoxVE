...
function update_script() {
  ...
  if check_for_gh_release "DroppedNeedle" "DroppedNeedle/DroppedNeedle"; then
    ...
    cp -a /opt/droppedneedle/backend/config /opt/droppedneedle_config_backup
    cp -a /opt/droppedneedle/backend/cache /opt/droppedneedle_cache_backup
    ...
    cp -a /opt/droppedneedle_config_backup/. /opt/droppedneedle/backend/config/
    cp -a /opt/droppedneedle_cache_backup/. /opt/droppedneedle/backend/cache/
    rm -rf /opt/droppedneedle_config_backup /opt/droppedneedle_cache_backup

...
function update_script() {
  ...
  while true; do
    CHOICE=$(
      whiptail --backtitle "Incus Scripts" --title "SUPPORT" --menu "Select option" 11 58 2 \
    ...
    1)
      ...
      ;;
    2)
      if NEWTOKEN=$(whiptail --backtitle "Incus Scripts" --passwordbox "Setup your ADMIN_TOKEN (make it strong)" 10 58 3>&1 1>&2 2>&3); then

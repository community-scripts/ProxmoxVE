...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/mattosaurus/ProxmoxVE/refs/heads/update-frigate-version/misc/copy-data/home-assistant-core-copy-data-home-assistant-core.sh)"

...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/cospeedster/ProxmoxVE/refs/heads/patch-1/misc/copy-data/home-assistant-container-copy-data-home-assistant-core.sh)"

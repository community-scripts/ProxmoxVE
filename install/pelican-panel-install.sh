...
echo "yes" | $STD php artisan p:environment:database --driver mariadb --host 127.0.0.1 --port 3306 --database "$MARIADB_DB_NAME" --username "$MARIADB_DB_USER" --password "$MARIADB_DB_PASS"

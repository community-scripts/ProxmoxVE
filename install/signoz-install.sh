...
fetch_and_deploy_gh_release "signoz-schema-migrator" "SigNoz/signoz-otel-collector" "prebuild" "v0.142.0" "/opt/signoz-schema-migrator" "signoz-schema-migrator_linux_amd64.tar.gz"

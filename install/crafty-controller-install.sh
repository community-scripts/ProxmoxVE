...
sudo update-alternatives --set java /usr/lib/jvm/temurin-25-jre-$(get_arch_value)/bin/java
...
Environment=PATH=/usr/lib/jvm/temurin-25-jre-$(get_arch_value)/bin:/opt/crafty-controller/crafty/.venv/bin:$PATH

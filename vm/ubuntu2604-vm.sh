...
# Author: MickLesk (CanbiZ) forked by gabrielsdelima75
...
\____/_.___/\__,_/_/ /_/\__/\__,_/   /____/\____(_)____/  /_/       |___/_/  /_/ (Resolute Raccoon)                                          
...
if whiptail --backtitle "Proxmox VE Helper Scripts" --title "Ubuntu 26.04 VM" --yesno "This will create a New Ubuntu 26.04 VM. Proceed?" 10 58; then
  :
else
...
function advanced_settings() {
  ...
  if (whiptail --backtitle "Proxmox VE Helper Scripts" --title "ADVANCED SETTINGS COMPLETE" --yesno "Ready to create a Ubuntu 26.04 VM?" --no-button Do-Over 10 58); then
...
URL=https://cloud-images.ubuntu.com/releases/server/resolute/release/ubuntu-26.04-server-cloudimg-amd64.img
sleep 2
msg_ok "${CL}${BL}${URL}${CL}"
